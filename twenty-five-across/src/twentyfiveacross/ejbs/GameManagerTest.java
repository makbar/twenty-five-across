...
public class GameManagerTest extends TestCase {
	...
	public void testGetSolveState() {
		try {
			assertTrue(gameMgr1.getSquares(-2345) == null);//Negative input			
			assertTrue(gameMgr1.getSquares(2345) == null);//Game that is not in the system
			assertTrue(gameMgr1.getSquares(813801187) == null);//In the system, but not an active game
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
